...
| File | Purpose | Doc |
|---|---|---|
| `lib/contexts.ts` | Intentions, durations, `VoiceChoice`, `CUSTOM_MAX_CHARS`, the Claude `SCRIPT_SYSTEM_PROMPT`, duration bands, feature flags | [product-spec](./product-spec.md) |
