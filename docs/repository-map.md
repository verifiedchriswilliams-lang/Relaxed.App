...
| `lib/history.ts` | On-device recent (10, with saved script) + favorites (100) + moods (50); `sessionSig`; recent-entry first-reveal flag | [product-spec](./product-spec.md), [data-privacy](./data-privacy.md) |
