...
export const CONTEXTS: SessionContext[] = [
  {
    ...
    intent:
      ...
      "the seat, the contact of the hands. When the mind wanders — and it will, that's completely " +
  ...
  },
  {
    ...
    intent:
      ...
      "the legs — letting each part grow heavy and give its weight to the bed, paired with long, slow " +
      "exhales. Reassure that there is nothing left to do and nowhere to be. It is completely fine — " +
      "encouraged — to drift off before the end. Never energize, never instruct anything effortful; " +
      "let the words thin out and trail into quiet.",
  },
  {
    id: "flow",
    label: "Focus",
    ...
    intent:
      ...
      "couple of grounding breaths, name one clear intention for the work ahead, and prime a state that " +
      "is calm but alert, relaxed but sharp — attention gathered to a single point. Close by inviting " +
      "the eyes to open, steady and ready to begin.",
  },
  {
    id: "relax",
    label: "Unwind",
    ...
    intent:
      ...
      "unclench the hands. Invite an unhurried sense of arriving fully in the present — that this " +
  ...
  },
  {
    ...
    intent:
      ...
      "out of the spinning head and back into the body. Lengthen the exhales to help the nervous system " +
      "settle. Then, gently, meet whatever is here instead of fighting it: quietly name the feeling, " +
      "allow it to be present, turn toward it with a little curiosity and kindness rather than " +
      "resistance. Reassure — plainly, never clinically — that this feeling is temporary and " +
...
// the 3–30 range via duration bands (below), so these are just convenient doses.
...
export const DURATION_BANDS: DurationBand[] = [
  {
    ...
    guidance:
      ...
      "a small handful of returns to it, and a short close. Stillness in 2–3s beats, occasionally two " +
      "in a row. Compact but never rushed.",
  },
  {
    id: "brief",
    minMinutes: 5,
    ...
    guidance:
      ...
      "four times with real silence between. Rest stretches of roughly 5–10 seconds (stack two or " +
  ...
  },
  {
    ...
    guidance:
      ...
      "stillness — rests equivalent to 10–20 seconds (several stacked break tags) are welcome. Let " +
  ...
  },
  {
    ...
    maxMinutes: 20,
    guidance:
      "Very spacious. Long stretches of silence — the equivalent of 20–40 seconds (many stacked " +
...
OUTPUT
Output ONLY the spoken words plus <break> tags. No titles, headings, stage directions in brackets, markdown, or quotation marks around the whole thing. Return the script and nothing else.`;
